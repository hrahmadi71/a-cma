...
import edu.atilim.acma.search.GamblerAccountantAgentAlgorithm;
...
import edu.atilim.acma.search.LearnerAgentAlgorithm;
...
public class DesignPanel extends DesignPanelBase implements WindowEventListener {
	...
	private void initRunButtons() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < runs; i++)
				{
				    ...
				    if (e.getActionCommand().equals("RS")) {
						...
						int mi = (Integer) gapActionIterationCount.getValue();
						algo = new GamblerAccountantAgentAlgorithm(new SolutionDesign(design, getRunConfig()), null, mi);
					}
		...
		aapBtnStart.addActionListener(algoListener);
		gapBtnStart.addActionListener(algoListener);
