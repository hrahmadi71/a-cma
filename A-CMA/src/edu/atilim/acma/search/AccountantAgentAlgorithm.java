...
public class AccountantAgentAlgorithm extends AbstractAlgorithm {
	...
	public AccountantAgentAlgorithm(SolutionDesign initialDesign, AlgorithmObserver observer, int maxIters) {
